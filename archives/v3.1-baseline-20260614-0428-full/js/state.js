...
function getBondGiftStats(roleId) {
  if (!roleId) return { exp: 0, gifts: 0, coinsSpent: 0, lastGiftId: null, repeatGiftStreak: 0 };
  if (!State.bonds) State.bonds = {};
...
function recordOrderCompletion(order) {
  ...
  // Serving a named character slowly builds relationship progress too.
