...
当前处于 v3.3：故事条件网络、特殊委托与半隐藏预告；代码与 CHANGELOG 已推进到 v3.3.23，已完成多模型协作框架整治（根目录清理、STATUS.json 单一真相、归档 post-flight、MANIFEST 机读化、agent 角色与结构化 backlog），尚未接入正式特殊委托任务系统
```
